...
<nav className="fixed top-0 left-0 w-full z-[9999] bg-gradient-to-r from-black via-[#0d0d0d] to-black backdrop-blur-md shadow-lg px-6 py-4 md:py-5 transition-all duration-500">
  ...
  <div className="flex items-center justify-between md:justify-around max-w-7xl mx-auto">
    ...
    <div className="flex-shrink-0">
      <Link
        to="/"
        className="text-2xl md:text-3xl font-extrabold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-600 hover:from-white hover:to-red-500 transition-all duration-300"
      >
...
<div className="hidden md:flex flex-1 justify-center">
  <div className="w-full max-w-3xl lg:max-w-6xl xl:max-w-2xl">
    <SearchBar
      className="w-full h-14 lg:h-16 xl:h-20 bg-[#111] border border-red-700/40 rounded-full shadow-inner px-6 text-lg lg:text-xl focus:ring-2 focus:ring-red-500 transition-all duration-300"
    />
  </div>
</div>
